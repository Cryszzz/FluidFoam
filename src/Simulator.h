#ifndef __SOP_SIMULATOR_h__
#define __SOP_SIMULATOR_h__
...
class SOP_SIMULATOR : public SOP_Node
{
public:
...
protected:
	...
	SOP_SIMULATOR(OP_Network *net, const char *name, OP_Operator *op);
    virtual ~SOP_SIMULATOR();
