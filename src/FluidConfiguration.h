#ifndef __SOP_FLUIDCONFIGURATION_h__
#define __SOP_FLUIDCONFIGURATION_h__
...
class SOP_FLUIDCONFIGURATION: public SOP_Node
{
public:
...
protected:
	...
	SOP_FLUIDCONFIGURATION(OP_Network *net, const char *name, OP_Operator *op);
    virtual ~SOP_FLUIDCONFIGURATION();
