...
/*void runSimulationFromNode(const std::unordered_map<std::string, std::any>& params) {
    ...
    try {
        // Simulating the setup from command line arguments using parameter map
        bool help = std::any_cast<bool>(params.at("help"));
        if (help) {
        ...
        // For example:
        std::cout << "Running simulation with input: " << input << " and output: " << output << std::endl;

        // Potentially more code to handle simulation steps based on the provided parameters...
