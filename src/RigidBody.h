#ifndef __SOP_RIGIDBODY_h__
#define __SOP_RIGIDBODY_h__
...
class SOP_RIGIDBODY : public SOP_Node
{
public:
...
protected:
	...
	SOP_RIGIDBODY(OP_Network *net, const char *name, OP_Operator *op);
    virtual ~SOP_RIGIDBODY();
